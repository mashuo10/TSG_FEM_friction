function tenseg_savegif_forever_CTS(name,d_time)
...
[f,map]=rgb2ind(f,256);
if iiii==0
	imwrite(f,map,filename,'LoopCount',loops,'delaytime',d_time);
else
	imwrite(f,map,filename,'writemode','append','delaytime',d_time);
end